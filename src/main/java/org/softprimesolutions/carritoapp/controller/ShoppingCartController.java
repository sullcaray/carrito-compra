...
public class ShoppingCartController {
    ...
    public String processPayment(@RequestParam String contactName, @RequestParam String creditCardNumber,@RequestParam String expirationDate,@RequestParam String cvv, Model model) {

        PaymentDetail paymentDetail =  new PaymentDetail();
        paymentDetail.setCardholder(contactName);
